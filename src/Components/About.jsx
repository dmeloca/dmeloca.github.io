...
const imageAltText = "Abstract geometric shapes in various colors.";
 ...
 */
const skillsList = ["Python", "Bash", "Conda", "Maths", "Cybersecurity", "Learning"];
